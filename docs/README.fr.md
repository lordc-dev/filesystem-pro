...
| `MCP_RG_TIMEOUT_MS`     | `10000`    | Tuer ripgrep s'il dépasse ce délai (ms)          |
...
- **Ripgrep ne dévorera pas votre RAM** — SIGTEM au seuil OOM. Max 8 processus simultanés, délai de 10s
