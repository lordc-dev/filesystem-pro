...
Alternativement, passez les répertoires autorisés en arguments CLI (repli quand les roots ne sont pas disponibles) :
...
| `MCP_TEMPLATES_DIR` |            | Répertoire de modèles personnalisés                        |
