...
```json
{
  "mcpServers": {
    "filesystem": {
      "command": "node",
      "args": ["/ruta/a/filesystem-pro/dist/index.js"],
      "env": {
...
Alternativamente, pasa directorios permitidos como argumentos CLI (fallback cuando roots no está disponible):

```bash
node dist/index.js /ruta/a/dir1 /ruta/a/dir2
```
